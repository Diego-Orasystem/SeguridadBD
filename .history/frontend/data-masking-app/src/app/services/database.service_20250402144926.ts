...
export class DatabaseService {
  ...
  // Alias para getTableData, usado para vistas previas
  getTablePreview(tableName: string, schema?: string, limit: number = 5): Observable<ApiResponse<TableData[]>> {
    return this.getTableData(tableName, schema, limit);
  }
